        ...
        !(function (t, e) {
          ...
          var i = function () {
            e.hooks.addAction("frontend/element_ready/global", function (t) {
              ...
              if (e.length)
                return (
                  e.attr({ "data-element_type": t.data("element_type") }).data({
                    id: t.data("id"),
                    widget_type: t.data("widget_type"),
                    settings: t.data("settings"),
                  }),
                  void new n({ $element: e })
                );
              new n({ $element: t });
            });
          };
            ...
            n = o.extend({
              bindEvents: function () {
                elementorFrontend.addListenerOnce(
                  this.getUniqueHandlerID() + "ekit_sticky",
                  "resize",
                  this.run,
                );
              },
              ...
              activate: function () {
                var i = this.getElementSettings(),
                  ...
                  n = {
                    ...
                    effectsOffset: this.getResponsiveValue(
                      "ekit_sticky_effect_offset",
                    ),
                    classes: {
                      sticky: "ekit-sticky",
                      stickyActive:
                        "ekit-sticky--active ekit-section--handles-inside",
                ...
                "column" === i.ekit_sticky && ((n.to = "top"), (n.column = !0)),
                  ...
                  e.hooks.addFilter(
                    ...
                    function (e) {
                      var i = t(
                        ".elementor-top-section.ekit-sticky--active:visible",
                      );
              ...
              run: function (t) {
                if (this.getElementSettings("ekit_sticky")) {
                  ...
                  e === this.getElementSettings("ekit_sticky_on_" + e)
                    ? !0 === t || this.isStickyOn()
                      ? this.reactivate()
                      : this.activate()
                    : this.deactivate();
            ...
            var o,
              ...
              y = function (t, e, i) {
                var o = getComputedStyle(t[0]),
                  ...
                  r = [];
                return (
                  "border-box" !== o.boxSizing && r.push("border", "padding"),
                  i && r.push("margin"),
              ...
              m = function (t) {
                var e = a.$window.scrollTop(),
                  ...
                  s = n - o;
                return {
                  top: { fromTop: n, fromBottom: s },
                  bottom: { fromTop: n + i, fromBottom: s + i },
                };
              },
              h = function () {
              ...
              g = function () {
                ...
                if (r)
                  (e
                    ? t.top.fromTop > n.offset
                    : t.bottom.fromBottom < -n.offset) &&
                    (a.$parent.css(d(a.$parent, "childNotFollowing")),
                    o.css(d(o, "notFollowing")),
                    (r = !1));
                else {
                  var i = m(a.$parent),
                    s = getComputedStyle(a.$parent[0]),
                    c = parseFloat(
                      s[e ? "borderBottomWidth" : "borderTopWidth"],
                    ),
              ...
              _ = function () {
                ...
                if (n.stopAt || n.column) {
                  ...
                  if (
                    ("bottom" === n.to &&
                      ((l = f - (this.innerHeight - i.clientHeight)),
                      (d = (p = this.scrollY + n.offset) <= l),
                      i.clientHeight),
                    d && n.column && "widget" === i.dataset.element_type)
                  )
                    return (
                      s && v(),
                      void (i.style.transform = "translateY(" + l + "px)")
                    );
                ...
                (n.stopAt || n.column) &&
                  ...
                  (function (t) {
                    c && -t < n.effectsOffset
                      ? (o.removeClass(n.classes.stickyEffects), (c = !1))
                      : !c &&
                        -t >= n.effectsOffset &&
