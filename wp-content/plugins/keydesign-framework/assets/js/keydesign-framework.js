jQuery(document).ready(function ($) {
  $(
    ".zoom-button-effect .elementskit-btn,.zoom-button-effect .keydesign-button",
  ).each(function () {
    $(this)
      .contents()
      .filter(function () {
  ...
  $(
    ".flip-button-effect .elementskit-btn, .flip-button-effect .ekit-popup-btn__has-icon, .flip-button-effect .keydesign-button,.flip-button-effect .elementskit-single-pricing .elementskit-pricing-btn",
  ).each(function () {
  ...
  if ($(".with-sidebar.sticky-sidebar").length) {
    $(".with-sidebar.sticky-sidebar .keydesign-sidebar").css(
      "--header-height",
...
jQuery(function ($) {
  ...
  $(".elementskit-navbar-nav li a").click(function () {
    if (
      $(".elementskit-menu-container").hasClass("ekit-nav-menu-one-page-yes")
    ) {
  ...
  if ($(".sticky-navigation").length) {
    var navLinks = document.querySelectorAll(
      ".sticky-navigation .ekit-stylish-list a",
    );
    var sections = document.querySelectorAll(
      "#main .e-con.e-flex.sticky-section",
    );
    var menuHeight =
      document.querySelector(".sticky-navigation").offsetHeight + 5;
