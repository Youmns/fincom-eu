    ...
    (!(function (t, e) {
      ((window.console = window.console || {
        ...
        (t.fn.footable = function (t, i) {
          return (
            (t = t || {}),
            this.filter("table").each(function (n, s) {
              e.init(s, t, i);
            })
          );
        }));
      var i = { events: [] };
      ((e.__debug__ = JSON.parse(localStorage.getItem("footable_debug")) || !1),
        (e.__debug_options__ =
          JSON.parse(localStorage.getItem("footable_debug_options")) || i),
        (e.debug = function (n, s) {
          if (!e.is.boolean(n)) return e.__debug__;
          ((e.__debug__ = n),
            e.__debug__
              ? (localStorage.setItem(
                  "footable_debug",
                  JSON.stringify(e.__debug__),
                ),
                (e.__debug_options__ = t.extend(!0, {}, i, s || {})),
                e.is.hash(s) &&
                  localStorage.setItem(
                    "footable_debug_options",
                    JSON.stringify(e.__debug_options__),
                  ))
        ...
        (e.getRow = function (e) {
          ...
          return (
            i.hasClass("footable-detail-row") && (i = i.prev()),
            i.data("__FooTableRow__")
          );
        }));
      ...
      (i.arr = {}),
      (i.arr.each = function (t, e) {
        if (i.is.array(t) && i.is.fn(e))
          for (var n = 0, s = t.length; n < s && !1 !== e(t[n], n); n++);
      }),
      (i.arr.get = function (t, e) {
        var n = [];
        if (!i.is.array(t)) return n;
        if (!i.is.fn(e)) return t;
        for (var s = 0, o = t.length; s < o; s++) e(t[s], s) && n.push(t[s]);
        return n;
      }),
      (i.arr.any = function (t, e) {
        if (!i.is.array(t)) return !1;
        e = i.is.fn(e) ? e : n;
        for (var s = 0, o = t.length; s < o; s++) if (e(t[s], s)) return !0;
        return !1;
      }),
      (i.arr.contains = function (t, e) {
        if (!i.is.array(t) || i.is.undef(e)) return !1;
        for (var n = 0, s = t.length; n < s; n++) if (t[n] == e) return !0;
        return !1;
      }),
      (i.arr.first = function (t, e) {
        if (!i.is.array(t)) return null;
        e = i.is.fn(e) ? e : n;
        for (var s = 0, o = t.length; s < o; s++) if (e(t[s], s)) return t[s];
        return null;
      }),
      (i.arr.map = function (t, e) {
        var n = [],
          s = null;
        if (!i.is.array(t) || !i.is.fn(e)) return n;
        for (var o = 0, r = t.length; o < r; o++)
          null != (s = e(t[o], o)) && n.push(s);
        return n;
      }),
      (i.arr.remove = function (t, e) {
        var n = [],
          s = [];
        if (!i.is.array(t) || !i.is.fn(e)) return s;
        for (var o = 0, r = t.length; o < r; o++)
          e(t[o], o, s) && (n.push(o), s.push(t[o]));
        for (
          n.sort(function (t, e) {
            return e - t;
          }),
      ...
      (i.arr.delete = function (t, e) {
        var n = -1,
          s = null;
        if (!i.is.array(t) || i.is.undef(e)) return s;
        for (var o = 0, r = t.length; o < r; o++)
          if (t[o] == e) {
            ((n = o), (s = t[o]));
            break;
          }
        return (-1 != n && t.splice(n, 1), s);
      }),
      (i.arr.replace = function (t, e, i) {
        var n = t.indexOf(e);
        -1 !== n && (t[n] = i);
      }),
      (function (t) {
        ((t.is = {}),
          (t.is.type = function (t, e) {
          ...
          (t.is.fn = function (e) {
            return (
              (t.is.defined(window) && e === window.alert) ||
          ...
          (t.is.jq = function (e) {
            return (
              t.is.defined(window.jQuery) && e instanceof jQuery && e.length > 0
            );
          }),
          (t.is.moment = function (e) {
            return (
              t.is.defined(window.moment) &&
              t.is.object(e) &&
              t.is.boolean(e._isAMomentObject)
            );
          }),
      ...
      (function (t) {
        ((t.str = {}),
          (t.str.contains = function (e, i, n) {
            return (
              !t.is.emptyString(e) &&
              !t.is.emptyString(i) &&
              i.length <= e.length &&
              -1 !==
                (n ? e.toUpperCase().indexOf(i.toUpperCase()) : e.indexOf(i))
            );
          }),
          (t.str.containsExact = function (e, i, n) {
            return (
              ...
              (n || ((e = e.toLowerCase()), (i = i.toLowerCase())),
              e.includes(i))
            );
          }),
          (t.str.containsWord = function (e, i, n) {
            if (
              ...
              return !1;
            for (var s = e.split(/\W/), o = 0, r = s.length; o < r; o++)
              if (n ? s[o].toUpperCase() == i.toUpperCase() : s[o] == i)
                return !0;
            return !1;
          }),
          (t.str.from = function (e, i) {
            return t.is.emptyString(e)
              ? e
              : t.str.contains(e, i)
                ? e.substring(e.indexOf(i) + 1)
                : e;
          }),
          ...
          (e.extend = function (n, s) {
            ...
            if (((n = o.shift()), (s = o.shift()), t.is.hash(n))) {
              var a = Object.create(this.prototype),
                l = this.prototype;
              for (var c in n) "__ctor__" !== c && r(a, c, n[c], l[c]);
              var u = t.is.fn(a.__ctor__)
                ? a.__ctor__
                : function () {
                    if (!t.is.fn(this.construct))
              ...
              return (
                (a.construct = t.is.fn(a.construct)
                  ? a.construct
                  : function () {}),
                (u.prototype = a),
                (a.constructor = u),
            ...
            t.is.string(n) &&
              t.is.fn(s) &&
              r(this.prototype, n, s, this.prototype[n]);
          }),
          (t.Class = e),
          (t.ClassFactory = t.Class.extend({
            construct: function () {
              this.registered = {};
            },
            contains: function (e) {
            ...
            load: function (e, i, n) {
              ...
              for (s in ((e = a.shift() || {}), r.registered))
                if (r.registered.hasOwnProperty(s)) {
                  ...
                  (e.hasOwnProperty(s) &&
                    ((o = e[s]),
                    t.is.string(o) && (o = t.getFnPointer(e[s])),
                    t.is.fn(o) &&
                      (u = {
                        name: s,
                        klass: o,
              ...
              for (s in e)
                e.hasOwnProperty(s) &&
                  !r.registered.hasOwnProperty(s) &&
                  ((o = e[s]),
                  t.is.string(o) && (o = t.getFnPointer(e[s])),
                  t.is.fn(o) && l.push({ name: s, klass: o, priority: 0 }));
              return (
                l.sort(function (t, e) {
            ...
            make: function (e, i, n) {
              ...
              return (
                (e = o.shift()),
                (s = this.registered[e]),
                t.is.fn(s.klass) ? this._make(s.klass, o) : null
              );
            },
            _make: function (t, e) {
              function i() {
      ...
      (function (t, e) {
        ((e.css2json = function (i) {
          ...
          for (
            var n, s, o, r = {}, a = i.split(";"), l = 0, c = a.length;
            l < c;
            l++
          )
            e.is.emptyString(a[l]) ||
              ((n = a[l].split(":")),
              e.is.emptyString(n[0]) ||
                e.is.emptyString(n[1]) ||
                ((s = e.str.toCamelCase(t.trim(n[0]))),
                (o = t.trim(n[1])),
                (r[s] = o)));
          return r;
        }),
      ...
      (function (t, e) {
        e.Cell = e.Class.extend({
          ...
          define: function (i) {
            ((this.$el = e.is.element(i) || e.is.jq(i) ? t(i) : null),
              (this.$detail = null));
            var n =
              e.is.hash(i) && e.is.hash(i.options) && e.is.defined(i.value);
            ((this.value = this.column.parser.call(
              this.column,
              e.is.jq(this.$el) ? this.$el : n ? i.value : i,
              this.ft.o,
            )),
              (this.o = t.extend(
                !0,
              ...
              (this.classes =
                e.is.jq(this.$el) && this.$el.attr("class")
                  ? this.$el.attr("class").match(/\S+/g)
                  : e.is.array(this.o.classes)
                    ? this.o.classes
                    : e.is.string(this.o.classes)
                      ? this.o.classes.match(/\S+/g)
                      : []),
              (this.style =
                e.is.jq(this.$el) && this.$el.attr("style")
                  ? e.css2json(this.$el.attr("style"))
                  : e.is.hash(this.o.style)
                    ? this.o.style
                    : e.is.string(this.o.style)
                      ? e.css2json(this.o.style)
                      : {}));
          },
          $create: function () {
            this.created ||
              ((this.$el = e.is.jq(this.$el) ? this.$el : t("<td/>"))
          ...
          val: function (i, n, s) {
            ...
            if (
              ...
              (this.value = o ? i.value : i),
              (this.classes = e.is.array(this.o.classes)
                ? this.o.classes
                : e.is.string(this.o.classes)
                  ? this.o.classes.match(/\S+/g)
                  : []),
              (this.style = e.is.hash(this.o.style)
                ? this.o.style
                : e.is.string(this.o.style)
                  ? e.css2json(this.o.style)
                  : {}),
              ...
              (a.append(this.format(this.value)),
                this._setClasses(a),
                this._setStyle(a),
                (e.is.boolean(n) && !n) || this.row.draw());
            }
          },
          _setClasses: function (t) {
            ...
            (t.removeAttr("class"),
              (i || n) &&
                (i && n
                  ? (s = this.classes.concat(this.column.classes).join(" "))
                  : i
                    ? (s = this.column.classes.join(" "))
                    : n && (s = this.classes.join(" ")),
                e.is.emptyString(s) || t.addClass(s)));
          },
          _setStyle: function (i) {
            ...
            (i.removeAttr("style"),
              (n || s) &&
                (n && s
                  ? (o = t.extend({}, this.column.style, this.style))
                  : n
                    ? (o = this.column.style)
                    : s && (o = this.style),
                e.is.hash(o) && i.css(o)));
      ...
      (function (t, e) {
        ((e.Column = e.Class.extend({
          construct: function (t, i, n) {
            ((this.ft = t),
              (this.type = e.is.emptyString(n) ? "text" : n),
              (this.virtual = !!e.is.boolean(i.virtual) && i.virtual),
              (this.$el = e.is.jq(i.$el) ? i.$el : null),
              (this.index = e.is.number(i.index) ? i.index : -1),
              (this.internal = !1),
              this.define(i),
              this.$create());
          },
          define: function (t) {
            ((this.hidden = !!e.is.boolean(t.hidden) && t.hidden),
              (this.visible = !e.is.boolean(t.visible) || t.visible),
              (this.name = e.is.string(t.name) ? t.name : null),
              null == this.name && (this.name = "col" + (t.index + 1)),
              (this.title = e.is.string(t.title) ? t.title : null),
              !this.virtual &&
                null == this.title &&
                e.is.jq(this.$el) &&
                (this.title = this.$el.html()),
              null == this.title && (this.title = "Column " + (t.index + 1)),
              (this.style = e.is.hash(t.style)
                ? t.style
                : e.is.string(t.style)
                  ? e.css2json(t.style)
                  : {}),
              (this.classes = e.is.array(t.classes)
                ? t.classes
                : e.is.string(t.classes)
                  ? t.classes.match(/\S+/g)
                  : []),
              (this.parser = e.checkFnValue(this, t.parser, this.parser)),
              (this.formatter = e.checkFnValue(
                this,
                t.formatter,
                this.formatter,
              )));
          ...
          $create: function () {
            (this.$el =
              !this.virtual && e.is.jq(this.$el) ? this.$el : t("<th/>"))
              .html(this.title)
        ...
        e.Row = e.Class.extend({
          ...
          define: function (i) {
            ...
            ((this.value = n ? (s ? i.value : i) : null),
              ...
              (this.expanded =
                (e.is.jq(this.$el) && this.$el.data("expanded")) ||
                this.o.expanded),
              (this.classes =
                e.is.jq(this.$el) && this.$el.attr("class")
                  ? this.$el.attr("class").match(/\S+/g)
            ...
            var o = this;
            ((o.value = {}),
              e.arr.each(o.cells, function (t) {
                o.value[t.column.name] = t.val();
              }));
          },
          $create: function () {
            if (!this.created) {
              ((this.$el = e.is.jq(this.$el) ? this.$el : t("<tr/>")).data(
                "__FooTableRow__",
                this,
              ),
                this._setClasses(this.$el),
              ...
              (e.arr.each(i.cells, function (t) {
                ...
                i.$el
                  .off("click.ft.row")
                  .on("click.ft.row", { self: i }, i._onToggle),
                (this.created = !0));
            }
          },
          ...
          val: function (i, n, s) {
            ...
            if (!e.is.hash(i))
              return (
                (e.is.hash(this.value) && !e.is.emptyObject(this.value)) ||
                  ((this.value = {}),
                  e.arr.each(this.cells, function (t) {
            ...
            if (
              ((this.o = t.extend(
                !0,
                { expanded: o.expanded, classes: o.classes, style: o.style },
                a ? i.options : {},
              )),
            ...
            ((s = !e.is.boolean(s) || s),
              e.arr.each(this.cells, function (t) {
                !t.column.internal &&
                  e.is.defined(o.value[t.column.name]) &&
                  t.val(o.value[t.column.name], !1, s);
              }),
              this.created &&
                s &&
                (this._setClasses(this.$el),
                this._setStyle(this.$el),
                (e.is.boolean(n) && !n) || this.draw()));
          },
          _setClasses: function (t) {
            ...
            (t.removeAttr("class"),
              i &&
                ((n = this.classes.join(" ")),
                e.is.emptyString(n) || t.addClass(n)));
          },
          _setStyle: function (t) {
            var i = !e.is.emptyObject(this.style),
              n = null;
            (t.removeAttr("style"),
              i && ((n = this.style), e.is.hash(n) && t.css(n)));
          },
          expand: function () {
            if (this.created) {
              var t = this;
              t.ft.raise("expand.ft.row", [t]).then(function () {
                ((t.__hidden__ = e.arr.map(t.cells, function (t) {
                  ...
                  t.__hidden__.length > 0 &&
                    (t.$details
                      .insertAfter(t.$el)
                      .children("td")
                      .first()
                      .attr("colspan", t.ft.columns.visibleColspan),
                    e.arr.each(t.__hidden__, function (t) {
                      t.collapse();
                    })),
            ...
            if (this.created) {
              ...
              i.ft.raise("collapse.ft.row", [i]).then(function () {
                (e.arr.each(i.__hidden__, function (t) {
                  ...
                  i.$details.detach(),
                  i.$el.removeAttr("data-expanded"),
                  i.$toggle
                    .removeClass("fooicon-minus")
                    .addClass("fooicon-plus"),
                  (e.is.boolean(t) && !t) || (i.expanded = !1),
                  i.ft.raise("collapsed.ft.row", [i]));
              });
            }
          },
          predraw: function (t) {
            this.created &&
              ...
              this.$toggle.detach(),
              (t = !e.is.boolean(t) || t) && this.$el.detach());
          },
          draw: function (t) {
            ...
            (e.arr.each(i.cells, function (t) {
              (t.$el.css(
                ...
                i.ft.rows.showToggle &&
                  i.ft.columns.hasHidden &&
                  (("first" == i.ft.rows.toggleColumn &&
                    t.column.index == i.ft.columns.firstVisibleIndex) ||
                    ("last" == i.ft.rows.toggleColumn &&
                      t.column.index == i.ft.columns.lastVisibleIndex)) &&
                  t.$el.prepend(i.$toggle),
                t.$el
                  .add(t.column.$el)
      ...
      (function (t, e) {
        ((e.instances = []),
          (e.Table = e.Class.extend({
            construct: function (i, n, s) {
              ((this._resizeTimeout = null),
                (this.id = e.instances.push(this)),
                (this.initialized = !1),
                (this.$el = (e.is.jq(i) ? i : t(i)).first()),
                (this.$loader = t("<div/>", {
                  class: "footable-loader",
                }).append(t("<span/>", { class: "fooicon fooicon-loader" }))),
                (this.o = t.extend(!0, {}, e.defaults, n)),
                (this.data = this.$el.data() || {}),
                (this.classes = []),
                (this.components = e.components.load(
                  e.is.hash(this.data.components)
            ...
            _preinit: function () {
              ...
              return this.raise("preinit.ft.table", [t.data]).then(function () {
                ...
                ((t.o.ajax = e.checkFnValue(t, t.data.ajax, t.o.ajax)),
                  (t.o.stopPropagation = e.is.boolean(t.data.stopPropagation)
                    ? t.data.stopPropagation
                    : t.o.stopPropagation));
                for (var n = 0, s = i.length; n < s; n++)
                  e.str.startsWith(i[n], "footable") || t.classes.push(i[n]);
                return (
                  t.$el.hide().after(t.$loader),
                  t.execute(!1, !1, "preinit", t.data)
                );
              });
            },
            _init: function () {
              ...
              return i.raise("init.ft.table").then(function () {
                ...
                return (
                  i.$el.addClass("footable footable-" + i.id),
                  e.is.hash(i.o.on) && i.$el.on(i.o.on),
                  0 == o.length && i.$el.append((o = t("<tfoot/>"))),
                  0 == s.length && i.$el.append("<tbody/>"),
                  0 == n.length && i.$el.prepend((n = t("<thead/>"))),
                  i.execute(!1, !0, "init").then(function () {
                    return (
                      i.$el.data("__FooTable__", i),
                      0 == o.children("tr").length && o.remove(),
                      0 == n.children("tr").length && n.remove(),
                      i
                        ...
                        .always(function () {
                          (t(window)
                            .off("resize.ft" + i.id, i._onWindowResize)
                            .on(
                              "resize.ft" + i.id,
                              { self: i },
                              i._onWindowResize,
                ...
                .then(function () {
                  return i.execute(!0, !0, "destroy").then(function () {
                    (i.$el
                      ...
                      .removeClass("footable-" + i.id),
                      e.is.hash(i.o.on) && i.$el.off(i.o.on),
                      t(window).off("resize.ft" + i.id, i._onWindowResize),
                      (i.initialized = !1),
                      (e.instances[i.id] = null));
                  });
                })
                .fail(function (t) {
                  e.is.error(t) &&
            ...
            raise: function (i, n) {
              var s = this,
                o =
                  e.__debug__ &&
                  (e.is.emptyArray(e.__debug_options__.events) ||
                    e.arr.any(e.__debug_options__.events, function (t) {
            ...
            execute: function (t, i, n, s, o) {
              ...
              t = r.shift();
              var a = r.shift()
                ? e.arr.get(this.components, function (t) {
                    return t.enabled;
                  })
                : this.components.slice(0);
              return (
                r.unshift(t ? a.reverse() : a),
                this._execute.apply(this, r)
              );
            },
                  ...
                  ? t
                      .Deferred(function (t) {
                        try {
                          var i = r[n].apply(r, l);
                          if (e.is.promise(i))
                            return i.then(t.resolve, t.reject);
                          t.resolve(i);
                        } catch (e) {
                          t.reject(e);
                        }
      ...
      (function (t, e) {
        e.is.undef(window.moment) ||
          ((e.DateColumn = e.Column.extend({
            construct: function (t, i) {
              (this._super(t, i, "date"),
                (this.formatString = e.is.string(i.formatString)
                  ? i.formatString
                  : "MM-DD-YYYY"));
            },
            parser: function (i) {
              if (e.is.element(i) || e.is.jq(i)) {
                var n = t(i).data("value");
                ((i = e.is.defined(n) ? n : t(i).text()),
                  e.is.string(i) && (i = isNaN(i) ? i : +i));
              }
            ...
            formatter: function (t, i, n) {
              return e.is.object(t) &&
                e.is.boolean(t._isAMomentObject) &&
                t.isValid()
            ...
            filterValue: function (i) {
              if (
                ((e.is.element(i) || e.is.jq(i)) &&
                  (i = t(i).data("filterValue") || t(i).text()),
                e.is.hash(i) &&
                  e.is.hash(i.options) &&
                  (e.is.string(i.options.filterValue) &&
                    (i = i.options.filterValue),
                  e.is.defined(i.value) && (i = i.value)),
                e.is.object(i) && e.is.boolean(i._isAMomentObject))
              )
                return i.format(this.formatString);
              if (e.is.string(i)) {
                if (isNaN(i)) return i;
                i = +i;
              }
              return e.is.number(i) || e.is.date(i)
                ? moment(i).format(this.formatString)
                : e.is.defined(i) && null != i
                  ? i + ""
                  : "";
            },
          })),
      ...
      (function (t, e) {
        ((e.HTMLColumn = e.Column.extend({
          ...
          parser: function (i) {
            if (
              (e.is.string(i) && (i = t(t.trim(i))),
              e.is.element(i) && (i = t(i)),
              e.is.jq(i))
            ) {
        ...
        ((e.NumberColumn = e.Column.extend({
          construct: function (t, i) {
            (this._super(t, i, "number"),
              (this.decimalSeparator = e.is.string(i.decimalSeparator)
                ? i.decimalSeparator
                : "."),
              (this.thousandSeparator = e.is.string(i.thousandSeparator)
                ? i.thousandSeparator
                : ","),
              (this.decimalSeparatorRegex = new RegExp(
                e.str.escapeRegExp(this.decimalSeparator),
                "g",
              )),
              (this.thousandSeparatorRegex = new RegExp(
                e.str.escapeRegExp(this.thousandSeparator),
                "g",
              )),
              (this.cleanRegex = new RegExp(
                "[^-0-9" + e.str.escapeRegExp(this.decimalSeparator) + "]",
                "g",
              )));
          },
          parser: function (i) {
            if (e.is.element(i) || e.is.jq(i)) {
              ...
              i = e.is.defined(n)
                ? n
                : t(i).text().replace(this.cleanRegex, "");
            }
            return (
              e.is.string(i) &&
                ((i = i
      ...
      (function (t, e) {
        ((e.Breakpoints = e.Component.extend({
          ...
          preinit: function (t) {
            var i = this;
            return this.ft
              .raise("preinit.ft.breakpoints", [t])
              .then(function () {
                for (var n in ((i.cascade = e.is.boolean(t.cascade)
                  ? t.cascade
                  : i.cascade),
                (i.o.breakpoints = e.is.hash(t.breakpoints)
                  ? t.breakpoints
                  : i.o.breakpoints),
                (i.getWidth = e.checkFnValue(i, t.getWidth, i.getWidth)),
                null == i.o.breakpoints &&
                  (i.o.breakpoints = { xs: 480, sm: 768, md: 992, lg: 1200 }),
                i.o.breakpoints))
                  i.o.breakpoints.hasOwnProperty(n) &&
                    (i.array.push(new e.Breakpoint(n, i.o.breakpoints[n])),
                    (i._classNames += "breakpoint-" + n + " "));
          ...
          calculate: function () {
            for (
              ...
              ((t = this.array[r]),
                ((!i && r == a - 1) ||
                  (o >= t.width &&
                    (!(s instanceof e.Breakpoint) || o < s.width))) &&
                  (i = t),
                i || n.push(t.name),
                (s = t));
            return (n.push(i.name), (this.hidden = n.join(" ")), i);
          },
          visible: function (t) {
            ...
            for (var i = t.split(" "), n = 0, s = i.length; n < s; n++)
              if (
                this.cascade
                  ? e.str.containsWord(this.hidden, i[n])
                  : i[n] == this.current.name
              )
                return !1;
            return !0;
          },
          check: function () {
            var t = this,
              i = t.get();
            i instanceof e.Breakpoint &&
              i != t.current &&
              t.ft
                .raise("before.ft.breakpoints", [t.current, i])
                .then(function () {
                  var e = t.current;
                  return (
                    (t.current = i),
          ...
          get: function (t) {
            return e.is.undef(t)
              ? this.calculate()
              : t instanceof e.Breakpoint
                ? t
                : e.is.string(t)
                  ? e.arr.first(this.array, function (e) {
                      return e.name == t;
                    })
                  : e.is.number(t) && t >= 0 && t < this.array.length
                    ? this.array[t]
                    : null;
          },
          getWidth: function () {
            return e.is.fn(this.o.getWidth)
      ...
      (function (t) {
        ((t.Column.prototype.breakpoints = null),
          (t.Column.prototype.__breakpoints_define__ = function (e) {
            this.breakpoints = t.is.emptyString(e.breakpoints)
              ? null
              : e.breakpoints;
          }),
        ...
        ((e.Columns = e.Component.extend({
          construct: function (t) {
            (this._super(t, !0),
              ...
              (this._fromHTML =
                e.is.emptyArray(t.o.columns) && !e.is.promise(t.o.columns)));
          },
          parse: function (i) {
            var n = this;
            return t.Deferred(function (i) {
              function s(i, n) {
                ...
                if (0 == i.length || 0 == n.length) s = i.concat(n);
                  ...
                  (e.arr.each(i.concat(n), function (t) {
                    ...
                    o++);
                  for (var r, a, l = 0; l < o; l++)
                    ((r = {}),
                      e.arr.each(i, function (t) {
                        if (t.index == l) return ((r = t), !1);
                      }),
                      (a = {}),
                      e.arr.each(n, function (t) {
                        if (t.index == l) return ((a = t), !1);
                      }),
              ...
              if (c.length > 0) {
                var u =
                  c.parent().is("tbody") &&
                  c.children().length == c.children("td").length;
                (u || (n.$header = c.addClass("footable-header")),
                  c.children("td,th").each(function (e, i) {
                    ((o = t(i)),
                      ((r = o.data()).index = e),
                      (r.$el = o),
                      (r.virtual = u),
              ...
              e.is.array(n.o.columns) && !e.is.emptyArray(n.o.columns)
                ? (e.arr.each(n.o.columns, function (t, e) {
                    ((t.index = e), a.push(t));
                  }),
                  n.parseFinalize(i, s(a, l)))
                : e.is.promise(n.o.columns)
                  ? n.o.columns.then(
                      function (t) {
          ...
          parseFinalize: function (t, i) {
            var n,
              ...
              o = [];
            (e.arr.each(i, function (t) {
              (n = e.columns.contains(t.type)
                ? e.columns.make(t.type, s.ft, t)
                : new e.Column(s.ft, t)) && o.push(n);
            }),
              e.is.emptyArray(o)
          ...
          preinit: function (t) {
            ...
            return i.ft.raise("preinit.ft.columns", [t]).then(function () {
              return i.parse(t).then(function (n) {
                ((i.array = n),
                  (i.showHeader = e.is.boolean(t.showHeader)
                    ? t.showHeader
                    : i.showHeader));
              });
            });
          ...
          predraw: function () {
            var t = this,
              i = !0;
            ((t.visibleColspan = 0),
              (t.firstVisibleIndex = 0),
              (t.lastVisibleIndex = 0),
              (t.hasHidden = !1),
              e.arr.each(t.array, function (e) {
                ((e.hidden = !t.ft.breakpoints.visible(e.breakpoints)),
                  !e.hidden &&
                    e.visible &&
                    (i && ((t.firstVisibleIndex = e.index), (i = !1)),
                    (t.lastVisibleIndex = e.index),
                    t.visibleColspan++),
                  e.hidden && (t.hasHidden = !0));
              }),
          ...
          draw: function () {
            (e.arr.each(this.array, function (t) {
              t.$el.css(
                "display",
                t.hidden || !t.visible ? "none" : "table-cell",
              );
            }),
              !this.showHeader &&
                e.is.jq(this.$header.parent()) &&
                this.$header.detach());
          },
          $create: function () {
            var i = this;
            ((i.$header = e.is.jq(i.$header)
              ? i.$header
              : t("<tr/>", { class: "footable-header" })),
              i.$header.children("th,td").detach(),
              e.arr.each(i.array, function (t) {
                i.$header.append(t.$el);
              }),
              i.showHeader &&
                !e.is.jq(i.$header.parent()) &&
                i.ft.$el.children("thead").append(i.$header));
          },
          get: function (t) {
            return t instanceof e.Column
              ? t
              : e.is.string(t)
                ? e.arr.first(this.array, function (e) {
                    return e.name == t;
      ...
      (function (t) {
        ((t.Defaults.prototype.columns = []),
          (t.Defaults.prototype.showHeader = !0));
      })(FooTable),
      (function (t, e) {
        ((e.Rows = e.Component.extend({
          construct: function (t) {
            (this._super(t, !0),
              ...
              (this.$empty = null),
              (this._fromHTML =
                e.is.emptyArray(t.o.rows) && !e.is.promise(t.o.rows)));
          },
          parse: function () {
            var i = this;
            return t.Deferred(function (t) {
              var n = i.ft.$el.children("tbody").children("tr");
              e.is.array(i.o.rows) && i.o.rows.length > 0
                ? i.parseFinalize(t, i.o.rows)
                : e.is.promise(i.o.rows)
                  ? i.o.rows.then(
                      function (e) {
                        i.parseFinalize(t, e);
                      },
            ...
            return i.ft.raise("preinit.ft.rows", [t]).then(function () {
              return i.parse().then(function (n) {
                ((i.all = n),
                  ...
                  (i.showToggle = e.is.boolean(t.showToggle)
                    ? t.showToggle
                    : i.showToggle),
                  (i.toggleSelector = e.is.string(t.toggleSelector)
                    ? t.toggleSelector
                    : i.toggleSelector),
                  (i.toggleColumn = e.is.string(t.toggleColumn)
                    ? t.toggleColumn
                    : i.toggleColumn),
                  "first" != i.toggleColumn &&
                    "last" != i.toggleColumn &&
                    (i.toggleColumn = "first"),
                  (i.emptyString = e.is.string(t.empty)
                    ? t.empty
                    : i.emptyString),
                  (i.expandFirst = e.is.boolean(t.expandFirst)
                    ? t.expandFirst
                    : i.expandFirst),
                  (i.expandAll = e.is.boolean(t.expandAll)
                    ? t.expandAll
                    : i.expandAll));
              });
            });
          ...
          $create: function () {
            this.$empty = t("<tr/>", { class: "footable-empty" }).append(
              t("<td/>").text(this.emptyString),
            );
          },
          draw: function () {
            var t = this,
          ...
          load: function (i, n) {
            ...
            (e.arr.each(n ? o : this.array, function (t) {
              t.predraw();
            }),
              (this.all = e.is.boolean(n) && n ? this.all.concat(o) : o),
              (this.array = this.all.slice(0)),
              this.ft.draw());
          },
          expand: function () {
      ...
      (function (t) {
        t.Filter = t.Class.extend({
          construct: function (e, i, n, s, o, r, a) {
            ((this.name = e),
              (this.space =
                !t.is.string(s) || ("OR" != s && "AND" != s) ? "AND" : s),
              (this.connectors = !t.is.boolean(o) || o),
              (this.ignoreCase = !t.is.boolean(r) || r),
              (this.hidden = !!t.is.boolean(a) && a),
              (this.query =
                i instanceof t.Query
                  ? i
                  : new t.Query(
                      i,
                      this.space,
          ...
          match: function (e) {
            return (
              !!t.is.string(e) &&
              (t.is.string(this.query) &&
                (this.query = new t.Query(
                  this.query,
                  this.space,
                  this.connectors,
                  this.ignoreCase,
                )),
              this.query instanceof t.Query && this.query.match(e))
            );
          },
          matchRow: function (e) {
            var i = this,
              n = t.arr
                .map(e.cells, function (e) {
                  return t.arr.contains(i.columns, e.column)
                    ? e.filterValue
                    : null;
                })
                .join(" ");
        ...
        ((e.Filtering = e.Component.extend({
          construct: function (t) {
            (this._super(t, t.o.filtering.enabled),
              ...
              (this.focus = t.o.filtering.focus),
              (this.container = t.o.filtering.container),
              (this.$container = null),
              (this.$row = null),
              (this.$cell = null),
              (this.$form = null),
          ...
          preinit: function (t) {
            var i = this;
            return i.ft.raise("preinit.ft.filtering").then(
              function () {
                (i.ft.$el.hasClass("footable-filtering") && (i.enabled = !0),
                  (i.enabled = e.is.boolean(t.filtering)
                    ? t.filtering
                    : i.enabled),
                  i.enabled &&
                    ((i.space = e.is.string(t.filterSpace)
                      ? t.filterSpace
                      : i.space),
                    (i.min = e.is.number(t.filterMin) ? t.filterMin : i.min),
                    (i.connectors = e.is.boolean(t.filterConnectors)
                      ? t.filterConnectors
                      : i.connectors),
                    (i.ignoreCase = e.is.boolean(t.filterIgnoreCase)
                      ? t.filterIgnoreCase
                      : i.ignoreCase),
                    (i.exactMatch = e.is.boolean(t.filterExactMatch)
                      ? t.filterExactMatch
                      : i.exactMatch),
                    (i.focus = e.is.boolean(t.filterFocus)
                      ? t.filterFocus
                      : i.focus),
                    (i.delay = e.is.number(t.filterDelay)
                      ? t.filterDelay
                      : i.delay),
                    (i.placeholder = e.is.string(t.filterPlaceholder)
                      ? t.filterPlaceholder
                      : i.placeholder),
                    (i.dropdownTitle = e.is.string(t.filterDropdownTitle)
                      ? t.filterDropdownTitle
                      : i.dropdownTitle),
                    (i.container = e.is.string(t.filterContainer)
                      ? t.filterContainer
                      : i.container),
                    (i.filters = e.is.array(t.filterFilters)
                      ? i.ensure(t.filterFilters)
                      : i.ensure(i.filters)),
                    i.ft.$el.hasClass("footable-filtering-left") &&
                      (i.position = "left"),
                    i.ft.$el.hasClass("footable-filtering-center") &&
                      (i.position = "center"),
                    i.ft.$el.hasClass("footable-filtering-right") &&
                      (i.position = "right"),
                    (i.position = e.is.string(t.filterPosition)
                      ? t.filterPosition
                      : i.position)));
              },
              function () {
          ...
          $create: function () {
            var i,
              ...
              }).append(t("<label/>", { class: "sr-only", text: "Search" })),
              s = t("<div/>", { class: "input-group" }).appendTo(n),
              o = t("<div/>", { class: "input-group-btn" }),
              r = t("<button/>", {
                type: "button",
                class: "btn btn-default dropdown-toggle",
              })
                .on("click", { self: this }, this._onDropdownToggleClicked)
                .append(t("<span/>", { class: "caret" }));
            ...
            (this.ft.$el.addClass("footable-filtering").addClass(i),
              (this.$container =
                null === this.container ? t() : t(this.container).first()),
              this.$container.length
                ...
                : ((this.$row = t("<tr/>", {
                  ...
                  }).prependTo(this.ft.$el.children("thead"))),
                  (this.$cell = t("<th/>")
                    .attr("colspan", this.ft.columns.visibleColspan)
                    .appendTo(this.$row)),
                  (this.$container = this.$cell)),
              (this.$form = t("<form/>", { class: "form-inline" })
                .append(n)
              ...
              (this.$button = t("<button/>", {
                ...
                .on("click", { self: this }, this._onSearchButtonClicked)
                .append(t("<span/>", { class: "fooicon fooicon-search" }))),
              (this.$dropdown = t("<ul/>", {
                class: "dropdown-menu dropdown-menu-right",
              })),
              e.is.emptyString(this.dropdownTitle) ||
                this.$dropdown.append(
                  t("<li/>", {
                    class: "dropdown-header",
                    text: this.dropdownTitle,
                  }),
                ),
              this.$dropdown.append(
                e.arr.map(this.ft.columns.array, function (e) {
                  return e.filterable
                    ? t("<li/>").append(
                        t("<a/>", { class: "checkbox" }).append(
                          t("<label/>", { html: e.title }).prepend(
                            t("<input/>", {
                              type: "checkbox",
                              checked: !0,
                            }).data("__FooTableColumn__", e),
                          ),
                        ),
                      )
                    : null;
              ...
              this.delay > 0 &&
                ...
                this.$dropdown.on(
                  ...
                  'input[type="checkbox"]',
                  { self: this },
                  this._onSearchColumnClicked,
                )),
              o.append(this.$button, r, this.$dropdown),
              s.append(this.$input, o));
          },
          predraw: function () {
          ...
          draw: function () {
            ...
            if (t instanceof e.Filter) {
              var i = t.query.val();
              (this.exactMatch &&
                this._exactRegExp.test(i) &&
                (i = i.replace(this._exactRegExp, "$1")),
                this.$input.val(i));
            } else this.$input.val(null);
            this.setButton(
              !e.arr.any(this.filters, function (t) {
                return !t.hidden;
              }),
            );
          },
          addFilter: function (t, i, n, s, o, r, a) {
            ...
            l instanceof e.Filter &&
              (this.removeFilter(l.name), this.filters.push(l));
          },
          ...
          filter: function (t) {
            var e = this;
            return (
              (e.filters = e.ensure(e.filters)),
              e.ft.raise("before.ft.filtering", [e.filters]).then(function () {
                if (((e.filters = e.ensure(e.filters)), t))
                  var i = e.$input.prop("selectionStart"),
                    n = e.$input.prop("selectionEnd");
                return e.ft.draw().then(function () {
                  (t &&
                    e.$input
                      .focus()
                      .prop({ selectionStart: i, selectionEnd: n }),
          ...
          clear: function () {
            return (
              (this.filters = e.arr.get(this.filters, function (t) {
                return t.hidden;
              })),
          ...
          _ensure: function (t, i) {
            return (e.is.hash(t) || t instanceof e.Filter) &&
              !e.is.emptyString(t.name) &&
              (!e.is.emptyString(t.query) || t.query instanceof e.Query)
              ? ((t.columns = e.is.emptyArray(t.columns)
                  ? i
                  : this.ft.columns.ensure(t.columns)),
                (t.ignoreCase = e.is.boolean(t.ignoreCase)
                  ? t.ignoreCase
                  : this.ignoreCase),
                (t.connectors = e.is.boolean(t.connectors)
                  ? t.connectors
                  : this.connectors),
                (t.hidden = !!e.is.boolean(t.hidden) && t.hidden),
                (t.space =
                  !e.is.string(t.space) ||
                  ("AND" !== t.space && "OR" !== t.space)
                    ? this.space
                    : t.space),
                (t.query = e.is.string(t.query)
                  ? new e.Query(t.query, t.space, t.connectors, t.ignoreCase)
                  : t.query),
                t instanceof e.Filter
                  ? t
                  : new e.Filter(
                      t.name,
                      t.query,
          ...
          _onSearchInputChanged: function (t) {
            var i = t.data.self,
              n =
                "keypress" == t.type &&
                !e.is.emptyString(String.fromCharCode(t.charCode)),
              s = "keyup" == t.type && (8 == t.which || 46 == t.which),
              o = "paste" == t.type;
            (n || s || o) &&
              (13 == t.which && t.preventDefault(),
              null != i._filterTimeout && clearTimeout(i._filterTimeout),
              (i._filterTimeout = setTimeout(function () {
                i._filterTimeout = null;
                var t = i.$input.val();
                t.length >= i.min
                  ? (i.exactMatch &&
                      !i._exactRegExp.test(t) &&
                      (t = '"' + t + '"'),
                    i.addFilter("search", t),
                    i.filter(i.focus))
                  : e.is.emptyString(t) && i.clear();
              }, i.delay)));
          },
          ...
          _onDropdownToggleClicked: function (e) {
            ...
            var i = e.data.self;
            (i.$dropdown.parent().toggleClass("open"),
              i.$dropdown.parent().hasClass("open")
                ? t(document).on(
                    "click.footable",
                    { self: i },
                    i._onDocumentClicked,
                  )
          ...
          _onDocumentClicked: function (e) {
            if (0 == t(e.target).closest(".dropdown-menu").length) {
              e.preventDefault();
              var i = e.data.self;
              (i.$dropdown.parent().removeClass("open"),
                t(document).off("click.footable", i._onDocumentClicked));
            }
          },
        })),
        ...
        t.Query = t.Class.extend({
          construct: function (e, i, n, s) {
            ((this._original = null),
              (this._value = null),
              (this.space =
                !t.is.string(i) || ("OR" != i && "AND" != i) ? "AND" : i),
              (this.connectors = !t.is.boolean(n) || n),
              (this.ignoreCase = !t.is.boolean(s) || s),
              (this.left = null),
              (this.right = null),
              (this.parts = []),
              (this.operator = null),
          ...
          match: function (e) {
            return t.is.emptyString(this.operator) || "OR" === this.operator
              ? this._left(e, !1) || this._match(e, !1) || this._right(e, !1)
              : "AND" === this.operator
                ? this._left(e, !0) && this._match(e, !0) && this._right(e, !0)
                : void 0;
          },
          _match: function (e, i) {
            var n = this,
            ...
            return t.is.emptyArray(n.parts) && n.left instanceof t.Query
              ? i
              : t.is.emptyArray(n.parts)
                ? s
                : ("OR" === n.space
                    ? t.arr.each(n.parts, function (i) {
                        if (i.empty && o) {
                          if (((s = !0), i.negate)) return (s = !1);
                        } else {
                          var r = (
                            i.exact ? t.str.containsExact : t.str.contains
                          )(e, i.query, n.ignoreCase);
                          if ((r && !i.negate && (s = !0), r && i.negate))
                            return (s = !1);
                        }
                      })
                    : ((s = !0),
          ...
          _parse: function () {
            if (!t.is.emptyString(this._value))
              if (/\sOR\s/.test(this._value)) {
                ...
                ((this.left = new t.Query(
                  e[0],
                  this.space,
                  this.connectors,
                  this.ignoreCase,
                )),
                  (this.right = new t.Query(
                    e[1],
                    this.space,
                    this.connectors,
                    this.ignoreCase,
          ...
          _part: function (e) {
            var i = { query: e, negate: !1, phrase: !1, exact: !1, empty: !1 };
            return (
              t.str.startsWith(i.query, "-") &&
                ((i.query = t.str.from(i.query, "-")), (i.negate = !0)),
              /^"(.*?)"$/.test(i.query)
                ? ((i.query = i.query.replace(/^"(.*?)"$/, "$1")),
                  (i.phrase = !0),
                  (i.exact = !0))
                : this.connectors &&
                  /(?:\w)+?([-_\+\.])(?:\w)+?/.test(i.query) &&
                  ...
                  (i.phrase = !0)),
              (i.empty = i.phrase && t.is.emptyString(i.query)),
              i
            );
          },
        });
      ...
      (function (t) {
        ((t.Cell.prototype.filterValue = null),
          (t.Cell.prototype.__filtering_define__ = function (t) {
            this.filterValue = this.column.filterValue.call(this.column, t);
          }),
          (t.Cell.prototype.__filtering_val__ = function (e) {
            t.is.defined(e) &&
              (this.filterValue = this.column.filterValue.call(this.column, e));
          }),
      ...
      (function (t, e) {
        ((e.Column.prototype.filterable = !0),
          (e.Column.prototype.filterValue = function (i) {
            if (e.is.element(i) || e.is.jq(i)) {
              var n = t(i).data("filterValue");
              return e.is.defined(n) ? "" + n : t(i).text();
            }
            if (e.is.hash(i) && e.is.hash(i.options)) {
              if (e.is.string(i.options.filterValue))
                return i.options.filterValue;
              e.is.defined(i.value) && (i = i.value);
            }
            return e.is.defined(i) && null != i ? i + "" : "";
          }),
          (e.Column.prototype.__filtering_define__ = function (t) {
            ((this.filterable = e.is.boolean(t.filterable)
              ? t.filterable
              : this.filterable),
              (this.filterValue = e.checkFnValue(
                this,
                t.filterValue,
                this.filterValue,
              )));
      ...
      (function (t) {
        t.Row.prototype.filtered = function (e) {
          var i = !0,
            n = this;
          return (
            t.arr.each(e, function (t) {
              if (0 == (i = t.matchRow(n))) return !1;
            }),
            i
          );
        };
        ...
        ((e.Sorting = e.Component.extend({
          ...
          preinit: function (t) {
            ...
            this.ft.raise("preinit.ft.sorting", [t]).then(
              function () {
                (i.ft.$el.hasClass("footable-sorting") && (i.enabled = !0),
                  (i.enabled = e.is.boolean(t.sorting) ? t.sorting : i.enabled),
                  i.enabled &&
                    (i.column = e.arr.first(i.ft.columns.array, function (t) {
                      return t.sorted;
                    })));
              },
              function () {
                ...
                (e.arr.each(i.ft.columns.array, function (e) {
                  e.sortable &&
                    e.$el
                      ...
                      .append(t("<span/>", { class: "fooicon fooicon-sort" }));
                }),
                  i.ft.$el.on(
                    "click.footable",
                    ".footable-sortable",
          ...
          predraw: function () {
            if (this.column) {
              ...
              this.ft.rows.array.sort(function (e, i) {
                return "DESC" == t.direction
                  ? t.sorter(
                      i.cells[t.index].sortValue,
                      e.cells[t.index].sortValue,
                    )
                  : t.sorter(
                      e.cells[t.index].sortValue,
                      i.cells[t.index].sortValue,
          ...
          toggleAllowed: function (t) {
            ((t = e.is.boolean(t) ? t : !this.allowed),
              (this.allowed = t),
          ...
          _sort: function (i, n) {
            ...
            return s.ft.raise("before.ft.sorting", [o]).then(function () {
              return (
                e.arr.each(s.ft.columns.array, function (t) {
                  t != s.column && (t.direction = null);
                }),
                (s.column = s.ft.columns.get(o.column)),
                s.column && (s.column.direction = e.Sorting.dir(o.direction)),
          ...
          _onSortClicked: function (e) {
            var i = e.data.self,
              ...
              s = n.is(".footable-asc, .footable-desc")
                ? n.hasClass("footable-desc")
                  ? "ASC"
                  : "DESC"
                : "ASC";
            i._sort(n.index(), s);
      ...
      (function (t) {
        ((t.Cell.prototype.sortValue = null),
          (t.Cell.prototype.__sorting_define__ = function (t) {
            this.sortValue = this.column.sortValue.call(this.column, t);
          }),
          (t.Cell.prototype.__sorting_val__ = function (e) {
            t.is.defined(e) &&
              (this.sortValue = this.column.sortValue.call(this.column, e));
          }),
          t.Cell.extend("define", function (t) {
      ...
      (function (t, e) {
        ((e.Column.prototype.direction = null),
          (e.Column.prototype.sortable = !0),
          (e.Column.prototype.sorted = !1),
          (e.Column.prototype.sorter = function (t, e) {
            return (
          ...
          (e.Column.prototype.__sorting_define__ = function (t) {
            ((this.sorter = e.checkFnValue(this, t.sorter, this.sorter)),
              (this.direction = e.is.type(t.direction, "string")
                ? e.Sorting.dir(t.direction)
                : null),
              (this.sortable = !e.is.boolean(t.sortable) || t.sortable),
              (this.sorted = !!e.is.boolean(t.sorted) && t.sorted),
              (this.sortValue = e.checkFnValue(
                this,
                t.sortValue,
                this.sortValue,
              )));
      ...
      (function (t, e) {
        (e.HTMLColumn.extend("__sorting_define__", function (i) {
          (this._super(i),
            (this.sortUse =
              e.is.string(i.sortUse) &&
              -1 !== t.inArray(i.sortUse, ["html", "text"])
                ? i.sortUse
                : "html"));
        }),
        ...
        ((e.Paging = e.Component.extend({
          construct: function (t) {
            (this._super(t, t.o.paging.enabled),
              ...
              (this.container = t.o.paging.container),
              (this.total = -1),
              (this.totalRows = 0),
              (this.previous = -1),
          ...
          preinit: function (t) {
            ...
            this.ft.raise("preinit.ft.paging", [t]).then(
              function () {
                (i.ft.$el.hasClass("footable-paging") && (i.enabled = !0),
                  (i.enabled = e.is.boolean(t.paging) ? t.paging : i.enabled),
                  i.enabled &&
                    ((i.size = e.is.number(t.pagingSize)
                      ? t.pagingSize
                      : i.size),
                    (i.current = e.is.number(t.pagingCurrent)
                      ? t.pagingCurrent
                      : i.current),
                    (i.limit = e.is.number(t.pagingLimit)
                      ? t.pagingLimit
                      : i.limit),
                    i.ft.$el.hasClass("footable-paging-left") &&
                      (i.position = "left"),
                    i.ft.$el.hasClass("footable-paging-center") &&
                      (i.position = "center"),
                    i.ft.$el.hasClass("footable-paging-right") &&
                      (i.position = "right"),
                    (i.position = e.is.string(t.pagingPosition)
                      ? t.pagingPosition
                      : i.position),
                    (i.countFormat = e.is.string(t.pagingCountFormat)
                      ? t.pagingCountFormat
                      : i.countFormat),
                    (i.container = e.is.string(t.pagingContainer)
                      ? t.pagingContainer
                      : i.container),
                    (i.total = Math.ceil(i.ft.rows.all.length / i.size))));
              },
              function () {
                i.enabled = !1;
              },
          ...
          $create: function () {
            ...
            if (
              (this.ft.$el.addClass("footable-paging").addClass(i),
              (this.$container =
                null === this.container ? null : t(this.container).first()),
              e.is.jq(this.$container))
            )
              this.$container.addClass("footable-paging-external").addClass(i);
            else {
              var n = this.ft.$el.children("tfoot");
              (0 == n.length && ((n = t("<tfoot/>")), this.ft.$el.append(n)),
                (this.$row = t("<tr/>", { class: "footable-paging" }).prependTo(
                  n,
                )),
                (this.$container = this.$cell =
                  t("<td/>")
            ...
            ((this.$wrapper = t("<div/>", {
              ...
              (this.$pagination = t("<ul/>", { class: "pagination" }).on(
                "click.footable",
                "a.footable-page-link",
                { self: this },
                this._onPageClicked,
              )),
              (this.$count = t("<span/>", { class: "label label-default" })),
              this.$wrapper.append(
                this.$pagination,
                t("<div/>", { class: "divider" }),
                this.$count,
          ...
          format: function (t) {
            ...
            return (
              0 == this.ft.rows.array.length
                ? ((e = 0), (i = 0))
                : (i = i > this.totalRows ? this.totalRows : i),
              t
          ...
          pageSize: function (t) {
            if (((t = parseInt(t)), isNaN(t))) return this.size;
            ((this.size = t),
              (this.total = Math.ceil(this.ft.rows.all.length / this.size)),
              e.is.jq(this.$wrapper) &&
          ...
          _set: function (i) {
            ...
            return n.ft.raise("before.ft.paging", [s]).then(function () {
              return (
                (s.page = s.page > s.total ? s.total : s.page),
                (s.page = s.page < 1 ? 1 : s.page),
                n.current == i
                  ? t.when()
              ...
              var e = this.total > 1,
                i = function (e, i, n) {
                  return t("<li/>", { class: n })
                    .attr("data-page", e)
                    .append(
                      t("<a/>", { class: "footable-page-link", href: "#" })
                        .data("page", e)
                        .html(i),
                    );
                };
              (this.$pagination.empty(),
                e &&
                  (this.$pagination.append(
                    i("first", this.strings.first, "footable-page-nav"),
                  ),
                  this.$pagination.append(
                    i("prev", this.strings.prev, "footable-page-nav"),
                  ),
                  this.limit > 0 &&
                    ...
                    this.$pagination.append(
                      i(
                        "prev-limit",
                        this.strings.prevPages,
                        "footable-page-nav",
                      ),
                    )));
              for (var n, s = 0; s < this.total; s++)
                ((n = i(s + 1, s + 1, "footable-page")),
                  this.$pagination.append(n));
              (e &&
                (this.limit > 0 &&
                  this.limit < this.total &&
                  this.$pagination.append(
                    i(
                      "next-limit",
                      this.strings.nextPages,
                      "footable-page-nav",
                    ),
                  ),
                this.$pagination.append(
                  i("next", this.strings.next, "footable-page-nav"),
                ),
                this.$pagination.append(
                  i("last", this.strings.last, "footable-page-nav"),
                )),
                (this._createdLinks = this.total));
            }
          },
          ...
          _onPageClicked: function (e) {
            if (
              (e.preventDefault(),
              !t(e.target).closest("li").is(".active,.disabled"))
            ) {
              var i = e.data.self,
                n = t(this).data("page");
              switch (n) {
      ...
      (function (t, e) {
        ((e.Editing = e.Component.extend({
          construct: function (i) {
            (this._super(i, i.o.editing.enabled),
              (this.pageToNew = i.o.editing.pageToNew),
              (this.alwaysShow = i.o.editing.alwaysShow),
              (this.column = t.extend(!0, {}, i.o.editing.column, {
                visible: this.alwaysShow,
              })),
              (this.position = i.o.editing.position),
              (this.showText = i.o.editing.showText),
              (this.hideText = i.o.editing.hideText),
              (this.addText = i.o.editing.addText),
              (this.editText = i.o.editing.editText),
              (this.deleteText = i.o.editing.deleteText),
              (this.viewText = i.o.editing.viewText),
              (this.allowAdd = i.o.editing.allowAdd),
              (this.allowEdit = i.o.editing.allowEdit),
              (this.allowDelete = i.o.editing.allowDelete),
              (this.allowView = i.o.editing.allowView),
              (this._$buttons = null),
              (this.callbacks = {
            ...
            this.ft.raise("preinit.ft.editing", [i]).then(
              function () {
                if (
                  ...
                  (n.enabled = e.is.boolean(i.editing) ? i.editing : n.enabled),
                  n.enabled)
                ) {
                  if (
                    ((n.pageToNew = e.is.boolean(i.editingPageToNew)
                      ? i.editingPageToNew
                      : n.pageToNew),
                    (n.alwaysShow = e.is.boolean(i.editingAlwaysShow)
                      ? i.editingAlwaysShow
                      : n.alwaysShow),
                    (n.position = e.is.string(i.editingPosition)
                      ? i.editingPosition
                      : n.position),
                    (n.showText = e.is.string(i.editingShowText)
                      ? i.editingShowText
                      : n.showText),
                    (n.hideText = e.is.string(i.editingHideText)
                      ? i.editingHideText
                      : n.hideText),
                    (n.addText = e.is.string(i.editingAddText)
                      ? i.editingAddText
                      : n.addText),
                    (n.editText = e.is.string(i.editingEditText)
                      ? i.editingEditText
                      : n.editText),
                    (n.deleteText = e.is.string(i.editingDeleteText)
                      ? i.editingDeleteText
                      : n.deleteText),
                    (n.viewText = e.is.string(i.editingViewText)
                      ? i.editingViewText
                      : n.viewText),
                    (n.allowAdd = e.is.boolean(i.editingAllowAdd)
                      ? i.editingAllowAdd
                      : n.allowAdd),
                    (n.allowEdit = e.is.boolean(i.editingAllowEdit)
                      ? i.editingAllowEdit
                      : n.allowEdit),
                    (n.allowDelete = e.is.boolean(i.editingAllowDelete)
                      ? i.editingAllowDelete
                      : n.allowDelete),
                    (n.allowView = e.is.boolean(i.editingAllowView)
                      ? i.editingAllowView
                      : n.allowView),
                    (n.column = new e.EditingColumn(
                      n.ft,
                      n,
                      t.extend(!0, {}, n.column, i.editingColumn, {
                    ...
                    n.column.index = 0;
                    for (var s = 0, o = n.ft.columns.array.length; s < o; s++)
                      n.ft.columns.array[s].index += 1;
                  }
                  (n.ft.columns.array.push(n.column),
                    n.ft.columns.array.sort(function (t, e) {
                      return t.index - e.index;
                    }),
                    (n.callbacks.addRow = e.checkFnValue(
                      n,
                      i.editingAddRow,
                      n.callbacks.addRow,
                    )),
                    (n.callbacks.editRow = e.checkFnValue(
                      n,
                      i.editingEditRow,
                      n.callbacks.editRow,
                    )),
                    (n.callbacks.deleteRow = e.checkFnValue(
                      n,
                      i.editingDeleteRow,
                      n.callbacks.deleteRow,
                    )),
                    (n.callbacks.viewRow = e.checkFnValue(
                      n,
                      i.editingViewRow,
                      n.callbacks.viewRow,
                    )));
          ...
          $create: function () {
            ...
            (this.ft.$el
              ...
              (this.$cell = t("<td/>")
                .attr("colspan", this.ft.columns.visibleColspan)
                .append(this.$buttonShow())),
              this.allowAdd && this.$cell.append(this.$buttonAdd()),
              this.$cell.append(this.$buttonHide()),
              this.alwaysShow &&
                this.ft.$el.addClass("footable-editing-always-show"),
              this.allowAdd || this.ft.$el.addClass("footable-editing-no-add"),
              this.allowEdit ||
                this.ft.$el.addClass("footable-editing-no-edit"),
              this.allowDelete ||
                this.ft.$el.addClass("footable-editing-no-delete"),
              this.allowView ||
                this.ft.$el.addClass("footable-editing-no-view"));
            var i = this.ft.$el.children("tfoot");
            (0 == i.length && ((i = t("<tfoot/>")), this.ft.$el.append(i)),
              (this.$row = t("<tr/>", { class: "footable-editing" })
                .append(this.$cell)
                .appendTo(i)));
          },
          $buttonShow: function () {
          ...
          _onEditClick: function (i) {
            ...
            s instanceof e.Row &&
              n.ft.raise("edit.ft.editing", [s]).then(function () {
          ...
          _onDeleteClick: function (i) {
            ...
            var n = i.data.self,
              s = t(this).closest("tr").data("__FooTableRow__");
            s instanceof e.Row &&
              n.ft.raise("delete.ft.editing", [s]).then(function () {
          ...
          _onViewClick: function (i) {
            ...
            var n = i.data.self,
              s = t(this).closest("tr").data("__FooTableRow__");
            s instanceof e.Row &&
              n.ft.raise("view.ft.editing", [s]).then(function () {
          ...
          $create: function () {
            (this.$el =
              !this.virtual && e.is.jq(this.$el)
                ? this.$el
                : t("<th/>", { class: "footable-editing" })).html(this.title);
          },
          parser: function (i) {
            if (
              (e.is.string(i) && (i = t(t.trim(i))),
          ...
          createCell: function (i) {
            ...
            return (
              e.is.jq(i.$el) &&
                (0 === this.index
                  ? s.prependTo(i.$el)
                  : s.insertAfter(i.$el.children().eq(this.index - 1))),
              new e.Cell(this.ft, i, this, s || s.html())
            );
          },
        })),
      ...
      (function (t, e) {
        ((e.Row.prototype.add = function (i) {
          ...
          return t.Deferred(function (t) {
            ...
            if (i)
              return n.ft.draw().then(function () {
                t.resolve(e);
              });
            t.resolve(e);
          });
          ...
          (e.Row.prototype.delete = function (i) {
            ...
            return t.Deferred(function (t) {
              ...
              if (
                e.is.number(s) &&
                s >= 0 &&
                s < n.ft.rows.all.length &&
                (n.ft.rows.all.splice(s, 1), i)
              )
                return n.ft.draw().then(function () {
                  t.resolve(n);
                });
          ...
          e.is.defined(e.Paging) &&
            e.Row.extend("add", function (t) {
              t = !e.is.boolean(t) || t;
              var i,
                n = this,
                s = this._super(t),
                o = n.ft.use(e.Editing);
              return o && o.pageToNew && (i = n.ft.use(e.Paging)) && t
                ? s.then(function () {
                    var t = i.unpaged.indexOf(n),
                      e = Math.ceil((t + 1) / i.size);
                    if (i.current !== e) return i.goto(e);
                  })
                : s;
            }),
          e.is.defined(e.Sorting) &&
            e.Row.extend("val", function (t, i) {
              i = !e.is.boolean(i) || i;
              var n = this._super(t);
      ...
      (function (t) {
        ((t.Rows.prototype.add = function (e, i) {
          var n = e;
          (t.is.hash(e) &&
            (n = new FooTable.Row(this.ft, this.ft.columns.array, e)),
            n instanceof FooTable.Row && n.add(i));
        }),
          (t.Rows.prototype.update = function (e, i, n) {
            var s = this.ft.rows.all.length,
              o = e;
            (t.is.number(e) && e >= 0 && e < s && (o = this.ft.rows.all[e]),
              o instanceof FooTable.Row && t.is.hash(i) && o.val(i, n));
          }),
          (t.Rows.prototype.delete = function (e, i) {
            var n = this.ft.rows.all.length,
              s = e;
            (t.is.number(e) && e >= 0 && e < n && (s = this.ft.rows.all[e]),
              s instanceof FooTable.Row && s.delete(i));
          }));
      })(FooTable),
      (function (t, e) {
        var i = 0,
        ...
        ((e.State = e.Component.extend({
          construct: function (t) {
            (this._super(t, t.o.state.enabled),
              ...
              (this.key =
                this._key +
                (e.is.string(t.o.state.key) ? t.o.state.key : this._uid())),
              (this.filtering =
                !e.is.boolean(t.o.state.filtering) || t.o.state.filtering),
              (this.paging =
                !e.is.boolean(t.o.state.paging) || t.o.state.paging),
              (this.sorting =
                !e.is.boolean(t.o.state.sorting) || t.o.state.sorting));
          },
          preinit: function (t) {
            var i = this;
            this.ft.raise("preinit.ft.state", [t]).then(
              function () {
                ((i.enabled = e.is.boolean(t.state) ? t.state : i.enabled),
                  i.enabled &&
                    ((i.key =
                      i._key + (e.is.string(t.stateKey) ? t.stateKey : i.key)),
                    (i.filtering = e.is.boolean(t.stateFiltering)
                      ? t.stateFiltering
                      : i.filtering),
                    (i.paging = e.is.boolean(t.statePaging)
                      ? t.statePaging
                      : i.paging),
                    (i.sorting = e.is.boolean(t.stateSorting)
                      ? t.stateSorting
                      : i.sorting)));
              },
              function () {
      ...
      (function (t) {
        t.Filtering &&
          ((t.Filtering.prototype.readState = function () {
            if (this.ft.state.filtering) {
              var e = this.ft.state.get("filtering");
              t.is.hash(e) &&
                !t.is.emptyArray(e.filters) &&
                (this.filters = this.ensure(e.filters));
            }
          }),
          (t.Filtering.prototype.writeState = function () {
            if (this.ft.state.filtering) {
              ...
              this.ft.state.set("filtering", { filters: e });
            }
          }),
      ...
      (function (t) {
        t.Paging &&
          ((t.Paging.prototype.readState = function () {
            if (this.ft.state.paging) {
              var e = this.ft.state.get("paging");
              t.is.hash(e) &&
                ((this.current = e.current), (this.size = e.size));
            }
          }),
      ...
      (function (t) {
        t.Sorting &&
          ((t.Sorting.prototype.readState = function () {
            if (this.ft.state.sorting) {
              var e = this.ft.state.get("sorting");
              if (t.is.hash(e)) {
                var i = this.ft.columns.get(e.column);
                i instanceof t.Column &&
                  ((this.column = i), (this.column.direction = e.direction));
              }
            }
          }),
          (t.Sorting.prototype.writeState = function () {
            this.ft.state.sorting &&
              this.column instanceof t.Column &&
      ...
      (function (t, e) {
        ((e.Export = e.Component.extend({
          ...
          columns: function () {
            var t = [];
            return (
              e.arr.each(this.ft.columns.array, function (e) {
                e.internal ||
                  t.push({
                    type: e.type,
                    name: e.name,
          ...
          json: function (t) {
            return JSON.parse(
              JSON.stringify({ columns: this.columns(), rows: this.rows(t) }),
            );
          },
          csv: function (t) {
            var i,
            ...
            return (
              e.arr.each(r, function (t) {
                (e.arr.each(t.cells, function (t, e) {
                  t.column.internal ||
                    ((i = t.column.stringify.call(
                      t.column,
                      t.value,
                      t.ft.o,
                      t.row.value,
      ...
      (function (t) {
        ((t.Column.prototype.__export_define__ = function (e) {
          ...
          t.is.defined(t.DateColumn) &&
            (t.DateColumn.prototype.stringify = function (e, i, n) {
              return t.is.object(e) &&
                t.is.boolean(e._isAMomentObject) &&
                e.isValid()
                ? e.format(this.formatString)
                : "";
            }),
